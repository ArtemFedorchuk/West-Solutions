...
var ELEMENTS = [
  ...
  "input", "ins", "kbd", "keygen", "label", "legend", "li", "link", "main", "map", "mark", "menu", "menuitem", "meta",
...
for (var i = 0; i < ELEMENTS.length; i++) {
  // we need a closure because the element variable is not block scoped
  (function () {
    var element = ELEMENTS[i];
    exports[element] = function (props, children) {
